...
_MC_NAMESPACE_FIELDS = {
    ...
    "prototype_logit_alpha",
    "prototype_logit_enabled",
    "prototype_logit_margin",
    "prototype_logit_max_slots",
    "prototype_logit_target_classes",
    "prototype_logit_temperature",
    "pretrain_weights",
    "projector_scale",
    "resolution",
    "sa_nheads",
    "segmentation_head",
    "proto_guidance_artifacts_path",
    "proto_guidance_aux_loss_enabled",
    "proto_guidance_aux_loss_weight",
    "proto_guidance_content_enabled",
    "proto_guidance_enabled",
    "proto_guidance_fusion_mode",
    "proto_guidance_gamma_content_init",
    "proto_guidance_gamma_content_max",
    "proto_guidance_gate_bias_init",
    "proto_guidance_lambda_pos_init",
    "proto_guidance_lambda_pos_max",
    "proto_guidance_monitor_log_interval",
    "proto_guidance_num_slots",
    "proto_guidance_position_enabled",
    "proto_guidance_target_classes",
    "proto_guidance_tau_p",
    "proto_guidance_visual_ema_momentum",
    "proto_guidance_visual_ema_update",
    "proto_guidance_w_t_init",
    "proto_guidance_w_v_init",
    "proto_guidance_warmup_epochs",
    "proto_guidance_dense_loss_enabled",
    "proto_guidance_dense_loss_weight",
    "proto_guidance_dense_iou_pos",
    "proto_guidance_dense_iou_ignore",
    "proto_guidance_dense_center_fallback_topk",
    "proto_guidance_dense_foreground_loss_enabled",
    "proto_guidance_dense_foreground_loss_weight",
    "proto_guidance_dense_background_ratio",
    "proto_guidance_position_score_mode",
    "proto_guidance_position_semantic_weight",
    "proto_guidance_position_score_std_ratio",
    "proto_guidance_slot_reduction",
    "proto_guidance_slot_reduction_tau",
    "proto_guidance_trainable_scope",
